 ...
 */
public class InquiriesQueryParam {
	...
	@ApiModelProperty(value = "詢價單需求日範圍")
    private Date[] requirementDates;
	...
	public Date[] getRequirementDates() {
		return requirementDates;
	}
	public void setRequirementDates(Date[] requirementDates) {
		this.requirementDates = requirementDates;
	}
